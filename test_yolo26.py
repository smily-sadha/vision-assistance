"""
YOLOv26 + OpenCV Complete Test Script
======================================
...
Usage:
    python yolo26_opencv_test.py                  # webcam (default)
    python yolo26_opencv_test.py --source image.jpg
    python yolo26_opencv_test.py --source video.mp4
    python yolo26_opencv_test.py --model yolo26s.pt --conf 0.4
"""
